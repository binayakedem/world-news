...
const API=`https://newsapi.org/v2/everything?q=apple&from=2023-01-09&to=2023-01-09&sortBy=popularity&apiKey=9e11ba0d1ccd47e288a6e25f970c5058`
const AppleNews =() => {
  ...
  <div className="container">
    <div className="row">
        ...
        <div className="col-6">
            <h1 className="text-center my-5 py-5 fs-1 text-danger shadow-lg">Todays Device News </h1>
        </div>
        <div className="col-3"></div>
    </div>
    <div className="row">
