...
const API=`https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=9e11ba0d1ccd47e288a6e25f970c5058`
const Business =() => {
  ...
  <div className="container">
    <div className="row">
        ...
        <div className="col-6">
            <h1 className="text-center my-5 py-5 fs-1 text-danger shadow-lg">News about Business </h1>
        </div>
        <div className="col-3"></div>
    </div>
    <div className="row">
