...
const API=`https://newsapi.org/v2/everything?q=tesla&from=2022-12-12&sortBy=publishedAt&apiKey=9e11ba0d1ccd47e288a6e25f970c5058`
const Tesla =() => {
  ...
  <div className="container">
    <div className="row">
        ...
        <div className="col-6">
            <h1 className="text-center my-5 py-5 fs-1 text-danger shadow-lg">News about Tesla </h1>
        </div>
        <div className="col-3"></div>
    </div>
    <div className="row">
